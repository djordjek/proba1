...
public class RestUpdateUserRequest implements Serializable{
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final RestUpdateUserRequest other = (RestUpdateUserRequest) obj;
    ...
    public String toString() {
        return "RestUpdateUserRequest[" + "firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", company=" + company + ", role=" + role + ", username=" + username + "]";
    }
