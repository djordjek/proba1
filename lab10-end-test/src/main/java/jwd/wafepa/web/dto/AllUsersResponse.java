...
public class AllUsersResponse implements Serializable{
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final AllUsersResponse other = (AllUsersResponse) obj;
    ...
    public String toString() {
        return "AllUsersResponse[" + "id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", company=" + company + ", role=" + role + ", username=" + username
                + "]";
    }
